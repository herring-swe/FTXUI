...
class FTXUIConan(ConanFile):
    ...
    def package_info(self):
        ...
        self.cpp_info.components["ftxui-dom"].set_property(
        ...
        self.cpp_info.components["ftxui-screen"].set_property(
        ...
        self.cpp_info.components["ftxui-screen"].names["cmake_find_package_multi"] = (
            "screen"
        )
        self.cpp_info.components["ftxui-component"].names["cmake_find_package"] = (
            "component"
        )
        self.cpp_info.components["ftxui-component"].names[
